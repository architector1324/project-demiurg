...
| `--deep`    | Погружается в конкретный элемент или подсистему существующего мира и рекурсивно семантически развивает его детали. **Мир автоматически раскрывает свою внутреннюю сложность.** | *В разработке* |
