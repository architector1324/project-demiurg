...
| -- | -- | :--- |
| `--create`     | Генерирует совершенно новую, высокоуровневую реальность из короткого промпта.                                                                                         | **Готово** |
| `--explore` | Исследует существующую реальность на основе её уже сгенерированного JSON, позволяя задавать вопросы или извлекать факты. **Эта команда не изменяет состояние мира.** | **Готово** |
