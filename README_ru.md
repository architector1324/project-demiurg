...
*(Показана только ключевая цепочка разворачивания. Полная, исправленная версия JSON с полными деталями доступна [здесь](./examples/Deep%20Materialization/A%20woman%20sitting%20at%20a%20table%20in%20a%20restaurant%20in%20New%20York/world.json).)*
